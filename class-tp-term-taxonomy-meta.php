...
class TP_Term_Taxonomy_Meta {
	...
	/**
	 * Register term_taxonomymeta table
	 */
	function init() {
	...
	function maybe_create_table() {
		if( $this->db_version != get_option( 'tp_term_taxonomy_meta_db_version' ) )
			$this->create_table();
	}
	...
	function create_table() {
		...
		update_option( 'tp_term_taxonomy_meta_db_version', $this->db_version );
	}
